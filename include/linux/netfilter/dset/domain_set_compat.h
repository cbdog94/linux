#ifndef __DOMAIN_SET_COMPAT_H
#define __DOMAIN_SET_COMPAT_H
...
#define HAVE_IS_ZERO_ETHER_ADDR
#define HAVE_NLA_PUT_BE16
#define HAVE_NLA_PUT_BE64
#define HAVE_NLA_PUT_64BIT
...
#undef HAVE_NET_OPS_ASYNC
#define HAVE_USER_NS_IN_STRUCT_NET
...
#undef HAVE_EXPORT_SYMBOL_GPL_IN_MODULE_H
#define HAVE_TC_SKB_PROTOCOL
#undef HAVE_NET_IN_XT_ACTION_PARAM
#define HAVE_STATE_IN_XT_ACTION_PARAM
#define HAVE_XT_FAMILY
#define HAVE_XT_NET
#define HAVE_NFNL_MSG_TYPE
#define HAVE_NETLINK_EXTENDED_ACK
#define HAVE_PASSING_EXTENDED_ACK_TO_PARSERS
#define HAVE_PASSING_EXTENDED_ACK_TO_CALLBACKS
#undef HAVE_TYPEDEF_SCTP_SCTPHDR_T
#define HAVE_TIMER_SETUP
#define HAVE_STRSCPY
#define HAVE_LOCKDEP_NFNL_IS_HELD
...
#ifndef DOMAIN_SET_COMPAT_HEADERS

#ifndef CONFIG_DOMAIN_SET_MAX
#ifdef DOMAIN_SET_MAX
#define CONFIG_DOMAIN_SET_MAX	DOMAIN_SET_MAX
#else
#define CONFIG_DOMAIN_SET_MAX	256
#endif
#endif
...
#define DSET_NLA_PUT_NET64(skb, t, v, pa) nla_put_net64(skb, t, v, pa)
#else
#define DSET_NLA_PUT_NET64(skb, t, v, pa) nla_put_net64(skb, t, v)
#endif
...
#define DSET_CBFN(fn, net, nl, skb, nlh, cda, e)	fn(net, nl, skb, nlh, cda, e)
#define DSET_CBFN_AD(fn, net, nl, skb, ad, nlh, cda, e) fn(net, nl, skb, ad, nlh, cda, e)
#define DSET_SOCK_NET(net, ctnl)			net
#elif defined(HAVE_NET_IN_NFNL_CALLBACK_FN)
#define DSET_CBFN(fn, net, nl, skb, nlh, cda, e)	fn(net, nl, skb, nlh, cda)
#define DSET_CBFN_AD(fn, net, nl, skb, ad, nlh, cda, e) fn(net, nl, skb, ad, nlh, cda)
#define DSET_SOCK_NET(net, ctnl)			net
#else
#define DSET_CBFN(fn, net, nl, skb, nlh, cda, e)	fn(nl, skb, nlh, cda)
#define DSET_CBFN_AD(fn, net, nl, skb, ad, nlh, cda, e) fn(nl, skb, ad, nlh, cda)
#define DSET_SOCK_NET(net, ctnl)			sock_net(ctnl)
#endif
...
#ifdef HAVE_XT_NET
#define DSET_DEV_NET(par)	xt_net(par)
#elif defined(HAVE_NET_IN_XT_ACTION_PARAM)
#define DSET_DEV_NET(par)	(par)->net
#else
#define DSET_DEV_NET(par)	dev_net((par)->in ? (par)->in : (par)->out)
#endif
...
#endif /* DOMAIN_SET_COMPAT_HEADERS */
#endif /* __DOMAIN_SET_COMPAT_H */
